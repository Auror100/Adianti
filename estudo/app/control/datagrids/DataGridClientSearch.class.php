<?php
class DataGridClientSearch extends TPage
{
    public function __construct()
    {
        ...
        */
        ...
        $input_busca = new TEntry('input_busca'); // Cria o input
        $input_busca->placeholder='Busca...'; 
        $input_busca->setSize('100%');
        
        $this->datagrid->enableSearch($input_busca,'id,nome'); // Habilita as pesquisas sobre os campos colocados no final
        
        
        $panel = new TPanelGroup('Datagrid');
        $panel->addHeaderWidget($input_busca); // Adiciona o buscador no cabeçalho da datagrid
