<?php
class DataGridAutoHide extends TPage
{
    public function __construct()
    {
        ...
        $col_nome->enableAutoHide(900); // Diz em quantos pixels a informação irá sair da tela
        $col_cidade->enableAutoHide(800);
        $col_estado->enableAutoHide(700);
        $col_email->enableAutoHide(600);
        $col_telefone->enableAutoHide(500);
