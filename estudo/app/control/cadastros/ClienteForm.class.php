...
class ClienteForm extends TPage
{
    ...
    public function __construct()
    {
        ...
        $cidade_id = new TDBUniqueSearch('cidade_id','sample','Cidade','id','nome');
        $nascimento =  new TDate('nascimento');
        $email = new TEntry('email');
        $genero =  new TRadioGroup('genero');
        $situacao = new TCombo('situacao');
        $categoria_id = new TDBCombo('categoria_id','sample','Categoria','id','nome');
        ...
        $habilidades = new TDBCheckGroup('lista_habilidades','sample','Habilidade','id','nome');
